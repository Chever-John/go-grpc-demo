...
type DemoClient interface {
	...
	SendLargeData(ctx context.Context, in *LargeRequest, opts ...grpc.CallOption) (*LargeResponse, error)
}
...
func (c *demoClient) SendLargeData(ctx context.Context, in *LargeRequest, opts ...grpc.CallOption) (*LargeResponse, error) {
	out := new(LargeResponse)
	err := c.cc.Invoke(ctx, "/demo.Demo/SendLargeData", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DemoServer interface {
	...
	// SendLargeData frame too large error
	SendLargeData(context.Context, *LargeRequest) (*LargeResponse, error)
...
func (UnimplementedDemoServer) SendLargeData(context.Context, *LargeRequest) (*LargeResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SendLargeData not implemented")
}
...
func _Demo_SendLargeData_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(LargeRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DemoServer).SendLargeData(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/demo.Demo/SendLargeData",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DemoServer).SendLargeData(ctx, req.(*LargeRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Demo_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "SendLargeData",
			Handler:    _Demo_SendLargeData_Handler,
		},
	},
